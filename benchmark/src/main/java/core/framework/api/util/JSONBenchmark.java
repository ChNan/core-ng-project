...
public class JSONBenchmark {
    ...
    @Setup
    public  void setup() {
        jsonBytes = Strings.bytes(JSON_STR);
        object = JSON.fromJSON(UpdateProductRequest.class, JSON_STR);
    ...
    public void fromJSONString() {
        JSON.fromJSON(UpdateProductRequest.class, JSON_STR);
    }
